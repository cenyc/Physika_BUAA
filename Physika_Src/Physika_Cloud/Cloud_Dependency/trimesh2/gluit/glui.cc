...
void    GLUI_Main::display( void )
{
  ...
  glClearColor( (float) bkgd_color.r / 255.0f,
        (float) bkgd_color.g / 255.0f,
        (float) bkgd_color.b / 255.0f,
        1.0f );
...
GLUI_Main::GLUI_Main( void ) 
{
  ...
  bkgd_color_f[0] = 200.0f / 255.0f;
  bkgd_color_f[1] = 200.0f / 255.0f;
  bkgd_color_f[2] = 200.0f / 255.0f;
